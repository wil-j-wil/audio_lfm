...
fileName = 'stim398_walking_on_gravel'; % name of wav file
...
analysisRange = 12001:30000; % analysis range (chosen manually - smallest representative chunk of the signal)
...
lfmOpt.linit = 0.95; % initial guess for lengthscale
...
lfmOpt.sparsity_fb = [0 0 0 1 0 0 0 0 0 1]; % index which feedback terms to include (omit to optimise all)
...
lfmOpt.sparsity_fwd = [0 0 0 1 0 0 0 0 0 1]; % index which feedback terms to include (omit to optimise all)
