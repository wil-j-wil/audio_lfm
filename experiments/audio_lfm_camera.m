...
fileName = 'stim50_camera_snapping_photos'; % name of wav file
...
analysisRange = 18000:24000; % analysis range (chosen manually - smallest representative chunk of the signal)
DS = ceil(min(len)/6); % downsample rate
...
lfmOpt.linit = 0.7; % initial guess for lengthscale
