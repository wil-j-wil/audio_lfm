...
fileName = 'stim399_walking_on_hard_surface'; % name of wav file
...
analysisRange = 14001:32000; % analysis range (chosen manually - smallest representative chunk of the signal)
...
lfmOpt.fwdinit = 0.035; % initial guess for forward terms
...
lfmOpt.sparsity_fwd = [0 1 0 1 0 1 0 0 0 1]; % index which feedback terms to include (omit to optimise all)
