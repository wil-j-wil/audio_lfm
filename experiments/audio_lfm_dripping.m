...
fileName = 'stim132_water_dripping'; % name of wav file
...
len = [50 50]; % range of demodulation lengthscales (different frequencies tend to need different lengthscales)
...
analysisRange = 17001:35000; % analysis range (chosen manually - smallest representative chunk of the signal)
DS = 20; % downsample rate
...
lfmOpt.sig_noise = 0.002; % assumed measurement noise variance (automatically calculated below)
...
%% Manual Edit
lfmData.lfmOpt.sig_noise = 0.002; % assumed measurement noise variance (automatically calculated below)
...
if run_append == 1
    ...
    append_results = lfmData.append_results;
